...
Feature: TEST - VALIDATE API /v1/data/cmdb (POST) WITH INVALID FILTER FIELD
...
Scenario: SUBMIT POST REQUEST WITH INVALID FILTER FIELD
...
* match response.message == 'Invalid data field (filter field : NOT_CPU_Cores does not exists in AWS_CMDB_Output)'
