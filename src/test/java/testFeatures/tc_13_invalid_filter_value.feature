...
Feature: TEST - VALIDATE API /v1/data/cmdb (POST) WITH INVALID FILTER VALUE
...
Scenario: SUBMIT POST REQUEST WITH INVALID FILTER VALUE
...
* match response.message == 'Invalid data field (value: s#$ is not numeric)'
