...
Feature: TEST - VALIDATE API /v1/data/cmdb (POST) WITH NEGATIVE NUMERIC CURRENTPAGE VALUE
...
Scenario: SUBMIT POST REQUEST WITH NEGATIVE NUMERIC CURRENTPAGE VALUE
...
* match response.message == 'Invalid page number'
* match response.errorCode == 400006